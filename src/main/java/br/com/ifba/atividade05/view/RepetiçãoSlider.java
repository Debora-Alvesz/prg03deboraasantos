...
public class RepetiçãoSlider extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(RepetiçãoSlider.class.getName());

    /**
     * Creates new form view
     */
    public RepetiçãoSlider() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new RepetiçãoSlider().setVisible(true));
    }
